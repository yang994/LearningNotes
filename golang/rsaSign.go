...
func testRsa() {
	...
	msg := "glkseh12l4j23l;4kjjk3jh1l34hd1lk3j4hdiu123h4d\nh12l4h32jlk412h3oi5hlk\th12lk3jh123ljk12j4kh1l24kj1h42"
	fmt.Println("msg:",msg)
	sign:=GetSign([]byte(msg),"private.pem")
	fmt.Println("sign:",sign)
	tf:=VerifySign([]byte(msg),sign,"public.pem")
	fmt.Println(tf)
